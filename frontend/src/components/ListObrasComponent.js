...
const ListObrasComponent = () => {
  ...
  return (
    <div className="container mt-5 row justify-content-center">
      ...
      <Link to="/add-obra" className="btn btn-primary mb-2 col-lg-9">
        Agregar nueva obra{" "}
      </Link>
      <div className="">
        <ContainerDatoObraComponent
          obras={obras}
          onRefrescarDatos={onRefrescarDatos}
        ></ContainerDatoObraComponent>
      </div>
      <div className="mt-5">
        <ContainerBuscadorByBPSComponent
          onObraFound={handleObraFound}
