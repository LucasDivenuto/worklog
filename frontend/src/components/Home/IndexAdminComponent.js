      ...
      <div className="row justify-content-center align-items-stretch">
        <div className="col-8 col-lg-4 mb-4">
          <div className="card cardsAdmin">
            ...
            <ul className="list-group list-group-flush">
              <Link title="Ir" to="/personas" className="no-decoration">
                <li className="list-group-item itemLink">
                  Ver listados/Buscar
                </li>
              </Link>
              <Link title="Ir" to="/add-persona" className="no-decoration">
                <li className="list-group-item itemLink">
                  Agregar nueva persona
                </li>
              </Link>
              <Link title="Ir" to="/assign-rol" className="no-decoration">
                <li className="list-group-item itemLink">
        ...
        <div className="col-8 col-lg-4 mb-4 ">
          <div className="card cardsAdmin">
            ...
            <ul className="list-group list-group-flush">
              <Link title="Ir" to="/obras" className="no-decoration">
                <li className="list-group-item itemLink">Ver listado/Buscar</li>
              </Link>
              <Link title="Ir" to="/add-obra" className="no-decoration">
                <li className="list-group-item itemLink">Agregar nueva obra</li>
              </Link>
            </ul>
          </div>
        </div>
        <div className="col-8 col-lg-4 mb-4 ">
          <div className="card cardsAdmin">
            ...
            <ul className="list-group list-group-flush">
              <Link title="Ir" to="/reporte" className="no-decoration">
                <li className="list-group-item itemLink">
